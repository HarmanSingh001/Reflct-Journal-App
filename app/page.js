    ...
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <div className="relative">
          ...
          <div className="bg-white rounded -2x1 p-4 max-full max-auto">
            <div className="border-b border-orange-orang-100 pb-4 mb-4 flex items-center justify-between">
      ...
      <div className="space-y-24 mt-24">
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-4 bg-white rounded-2xl p-6 border border-orange-100">
      ...
      <div className="mt-24">
        ...
        <Accordion type="single" collapsible className="w-full mx-auto">
          {faqs.map((faq, index) => {
            return (
              <AccordionItem key={faq.q} value={`items-${index}`}>
      ...
      <div className="mt-24">
        <Card className="bg-gradient-to-r from-orange-100 to-amber-100">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gl text-orange-700 mb-8 max-w-2xl mx-auto">
